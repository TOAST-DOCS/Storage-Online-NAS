...
> [참고]
> 2022년 7월 현재 지정된 서브넷에서만 NAS 스토리지에 접근할 수 있습니다.
>
> [참고]
> 2022년 7월 현재 프로젝트별로 사용 가능한 서브넷은 총 3개로 제한됩니다. 한도를 높이려면 고객 센터에 문의하세요.
...
NAS 스토리지를 삭제합니다. 스토리지 삭제는 연결한 인스턴스와 마운트 해제 후 삭제하는 것을 권장합니다.
...
스토리지를 스냅숏이 생성된 시점으로 복원합니다. 2022년 7월 현재 스냅숏 복원은 고객센터 문의를 통해서 가능합니다.
...
지정된 스냅숏을 삭제합니다. 한 번 삭제된 스냅숏은 다시 복구할 수 없습니다.

### 모니터링 도구

NAS 스토리지의 여러 지표를 그래프와 함께 확인합니다. 모니터링 지표를 확인하고자 하는 스토리지를 선택 후, **모니터링** 탭을 선택하여 확인합니다.

기본 조회 기간은 마지막 1시간이며, 조회 기간 필터를 통해 원하는 기간을 조회할 수 있습니다. 모니터링 지표나 도구에 대한 자세한 가이드는 **[모니터링 가이드](/Storage/NAS/ko/monitoring-guide)**를 참고하세요.
