...
!!! tip "알아두기"
    Secure Key Manager 서비스 요금 정책에 따라 키 저장소 사용 요금이 청구됩니다. 사용 요금에 대한 자세한 사항은 [Secure Key Manager 요금 안내](https://www.nhncloud.com/kr/service/security/secure-key-manager#price)를 참고합니다.
...
!!! tip "알아두기"
    ...
    사용 요금에 대한 자세한 사항은 [NAS 요금 안내](https://www.nhncloud.com/kr/service/storage/nas)를 참고합니다.
