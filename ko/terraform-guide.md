...
# ACL{% if encryption %}, 암호화 설정{% endif %} 등의 설정을 포함한 볼륨 생성하기
...
| 이름 | 타입 | 필수 | 변경 가능 | 설명 |
| --- | --- | --- | --- | --- |
| region | String | N | - | 생성할 볼륨의 리전<br>기본값은 공급자 설정 파일에 설정된 리전 |
| name | String | Y | - | 볼륨 이름 |
...
{%- endif %}
| mount_protocol | Object | N | - | 볼륨 생성 시 프로토콜 설정 객체 |
...
| snapshot_policy.schedule.time_offset | String | N | O | 스냅숏 자동 생성 기준 시간대 |
| snapshot_policy.schedule.weekdays | List | N | O | 스냅숏 자동 생성 요일<br>빈 목록은 매일을 의미하며, 요일은 0(일요일)부터 6(토요일)까지의 숫자 목록으로 지정합니다. |
...
| 이름 | 타입 | 필수 | 변경 가능 | 설명 |
| --- | --- | --- | --- | --- |
| region | String | N | - | 연결할 볼륨의 리전<br>기본값은 공급자 설정 파일에 설정된 리전 |
| volume_id | String | Y | - | 연결할 볼륨의 ID |
| subnet_id | String | Y | - | 연결할 서브넷 ID |
...
| 이름 | 타입 | 필수 | 변경 가능 | 설명 |
| --- | --- | --- | --- | --- |
| src_region | String | N | - | 원본 볼륨의 리전<br>기본값은 공급자 설정 파일에 설정된 리전 |
| src_volume_id | String | Y | - | 원본 볼륨의 ID |
| dst_region | String | Y | - | 복제 대상 볼륨의 리전 |
| dst_tenant_id | String | Y | - | 복제 대상 볼륨의 테넌트 ID |
