...
This document describes how to manage volumes and snapshots using the APIs provided by NHN Cloud NAS.
...
| volume\_mirror\_id | URL | String | O | Replication setting ID |
